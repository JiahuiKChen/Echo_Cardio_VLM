...
[[ -f "$WORKTREE/scripts/lvef_c3_canary_stage_worker.py" && ! -L "$WORKTREE/scripts/lvef_c3_canary_stage_worker.py" ]] || exit 65
...
exec "$ECHOPRIME_PYTHON" -I -B "$WORKTREE/scripts/lvef_c3_canary_stage_worker.py" \
