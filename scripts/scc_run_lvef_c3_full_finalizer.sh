...
JOB_STORAGE_PARENT="$JOB_STORAGE_BASE/finalizer_job_$JOB_ID"
JOB_STORAGE_ROOT="$JOB_STORAGE_PARENT/cohort"
...
exec "$PYTHON" -I -B -X pycache_prefix=/dev/null/lvef_c3_full_finalizer \
  "$WORKER" --run-cohort-finalizer
